            ...
            Storage::Dense {
                ...
                SpatialHashStats {
                    total_cells: (grid_dims.0 as usize)
                        .checked_mul(grid_dims.1 as usize)
                        .and_then(|n| n.checked_mul(grid_dims.2 as usize))
                        .expect("SpatialHashGrid grid has too many cells"),
...
mod tests {
    ...
    fn test_basic_insertion() {
        let mut hash =
            SpatialHashGrid::new(1.0, Vec3::new(0.0, 0.0, 0.0), Vec3::new(10.0, 10.0, 10.0));
    ...
    fn test_degenerate_extents_clamp_to_valid_dims() {
        let hash = SpatialHashGrid::new(1.0, Vec3::new(0.0, 0.0, 0.0), Vec3::new(0.0, 2.0, -3.0));
    ...
    fn test_insert_and_query_with_zero_extent_box() {
        let mut hash =
            SpatialHashGrid::new(1.0, Vec3::new(1.0, 1.0, 1.0), Vec3::new(1.0, 1.0, 1.0));
    ...
    fn test_non_finite_box_min_is_sanitized() {
        let mut hash = SpatialHashGrid::new(
            1.0,
    ...
    fn test_clear_works_for_both_modes() {
        ...
        // Sparse mode
        let mut sparse_hash = SpatialHashGrid::new(
            1.0,
            Vec3::new(0.0, 0.0, 0.0),
            Vec3::new(300.0, 300.0, 300.0),
        );
