...
pub enum PlanOutput {
    ...
    Bundle(BundleOutput),
    H2Order(H2OrderOutput),
    Helix(HelixOutput),
    HelixOrient(HelixOrientOutput),
    HydOrder(HydOrderOutput),
    SOrient(SOrientOutput),
    Spol(SpolOutput),
    Potential(PotentialOutput),
    StructureFactor(StructureFactorOutput),
    VanHove(VanHoveOutput),
    Mdmat(MdmatOutput),
...
pub struct CurrentOutput {
    pub conductivity_time: Vec<f32>,
    pub conductivity: Vec<f32>,
    pub conductivity_rows: usize,
    pub conductivity_cols: usize,
    ...
    pub dielectric_total: f32,
    pub mu_avg: f32,
    pub conductivity_static: Option<f32>,
}

pub struct BundleOutput {
    pub labels: Vec<String>,
    pub time: Vec<f32>,
    pub reference_axis: Vec<f32>,
    pub top: Vec<f32>,
    pub bottom: Vec<f32>,
    pub mid: Vec<f32>,
    ...
    pub z_shift: Vec<f32>,
    pub tilt: Vec<f32>,
    pub radial_tilt: Vec<f32>,
    pub lateral_tilt: Vec<f32>,
    pub kink: Vec<f32>,
    pub kink_angle: Vec<f32>,
    pub kink_radial: Vec<f32>,
    pub kink_lateral: Vec<f32>,
    pub frames: usize,
    pub axes: usize,
    pub has_kink: bool,
    pub use_z_reference: bool,
    pub mass_weighted: bool,
    pub used_box: bool,
    pub length_scale: f32,
}

pub struct H2OrderOutput {
    ...
    pub used_box: bool,
    pub length_scale: f32,
    pub dipole_unit: String,
}

pub struct HelixOutput {
    pub labels: Vec<String>,
    pub time: Vec<f32>,
    pub fragment_start: Vec<i32>,
    pub fragment_end: Vec<i32>,
    pub radius: Vec<f32>,
    pub twist: Vec<f32>,
    pub rise: Vec<f32>,
    pub length: Vec<f32>,
    ...
    pub hb4: Vec<f32>,
    pub hb5: Vec<f32>,
    pub ellipticity: Vec<f32>,
    pub fragment_mask: Vec<bool>,
    pub residue_rmsd: Vec<f32>,
    pub helicity_fraction: Vec<f32>,
    pub jca_ha: Vec<f32>,
    pub frames: usize,
    pub residues: usize,
    pub fit: bool,
    pub check_each_frame: bool,
    pub length_scale: f32,
    pub used_box: bool,
}

pub struct HelixOrientOutput {
    pub labels: Vec<String>,
    pub time: Vec<f32>,
    pub axis: Vec<f32>,
    pub center: Vec<f32>,
    pub residue_vector: Vec<f32>,
    pub normal: Vec<f32>,
    pub rise: Vec<f32>,
    pub radius: Vec<f32>,
    pub twist: Vec<f32>,
...
pub struct HydOrderOutput {
    ...
    pub bin_width: f32,
    pub axis: usize,
    pub plane_axes: [usize; 2],
    pub n_frames: usize,
    pub used_box: bool,
    pub length_scale: f32,
    pub interface_lower: Vec<f32>,
    pub interface_upper: Vec<f32>,
    pub interface_blocks: usize,
    pub interface_rows: usize,
    pub interface_cols: usize,
    pub interface_threshold: Option<f32>,
    pub block_size: usize,
}

pub struct SOrientOutput {
    pub cos_theta1: Vec<f32>,
    pub cos_theta1_distribution: Vec<f32>,
    pub abs_cos_theta2: Vec<f32>,
    pub abs_cos_theta2_distribution: Vec<f32>,
    pub r: Vec<f32>,
    pub mean_cos_theta1: Vec<f32>,
    pub mean_p2_theta2: Vec<f32>,
    pub cumulative_r: Vec<f32>,
    pub cumulative_cos_theta1: Vec<f32>,
    pub cumulative_p2_theta2: Vec<f32>,
    pub count_density: Vec<f32>,
    pub counts: Vec<u64>,
    pub window_count: u64,
    pub average_shell_size: f32,
    pub window_mean_cos_theta1: f32,
    pub window_mean_p2_theta2: f32,
    pub r_window: [f32; 2],
    pub cbin: f32,
    pub rbin: f32,
    pub r_profile_max: f32,
    pub use_vector23: bool,
    pub use_com: bool,
    pub n_frames: usize,
    pub n_reference_positions: usize,
    pub used_box: bool,
    pub length_scale: f32,
}

pub struct SpolOutput {
    pub r: Vec<f32>,
    pub cumulative_count: Vec<f32>,
    pub shell_count: Vec<u64>,
    pub shell_count_per_frame: Vec<f32>,
    pub average_shell_size: f32,
    pub average_dipole: f32,
    pub dipole_std: f32,
    pub average_radial_dipole: f32,
    pub average_radial_polarization: f32,
    pub window_count: u64,
    pub r_window: [f32; 2],
    pub bin_width: f32,
    pub r_hist_max: f32,
...
pub struct MdmatOutput {
    pub labels: Vec<String>,
    pub mean_matrix: Vec<f32>,
    pub time: Vec<f32>,
    pub frame_matrices: Vec<f32>,
    pub frames: usize,
    pub residues: usize,
    pub truncate: f32,
    pub used_box: bool,
    pub length_scale: f32,
    pub distinct_contact_atoms: Vec<u32>,
    pub mean_contact_atoms: Vec<f32>,
    pub contact_ratio: Vec<f32>,
    pub residue_atom_counts: Vec<u32>,
    pub mean_contact_atoms_per_residue_atom: Vec<f32>,
}

pub struct DensityMapOutput {
    pub axis1: Vec<f32>,
    pub axis2: Vec<f32>,
    pub matrix: Vec<f32>,
    pub rows: usize,
