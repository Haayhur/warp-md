...
pub struct SolventOrientationPlan {
...
impl Plan for SolventOrientationPlan {
...
pub(crate) fn minimum_image_between_atoms(
    ...
    minimum_image_vector(
        [
            x2[0] as f64 * length_scale,
            x2[1] as f64 * length_scale,
            x2[2] as f64 * length_scale,
        ],
        [
            x1[0] as f64 * length_scale,
            x1[1] as f64 * length_scale,
            x1[2] as f64 * length_scale,
        ],
        box_,
        length_scale,
    )
...
pub(crate) fn minimum_image_to_reference(
    ...
    minimum_image_vector(
        reference,
        [
            atom[0] as f64 * length_scale,
            atom[1] as f64 * length_scale,
            atom[2] as f64 * length_scale,
        ],
        box_,
        length_scale,
    )
